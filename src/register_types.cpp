...
void initialize_opus_module(ModuleInitializationLevel p_level) {
	...
	ClassDB::register_class<GodotOpus>();
}
...
extern "C" {
// Initialization.
GDExtensionBool GDE_EXPORT godot_opus_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
